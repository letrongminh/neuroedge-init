...
> nguồn sự thật duy nhất về tiến độ. Cập nhật nguồn: **2026-09-23**.
...
| Trạng thái CI Lõi | ✅ **PASS 573/573 · SKIP 0** |
...
|  | **Sprint 3 — Action CI & Linux** *(≈ A2)* | **2026-10-26 → 2026-11-15** (Q-19) | **11 / 17** | 🟡 Action CI + HAL `linux` xong (2026-09-23); tiêu chí ra 5/6 |
