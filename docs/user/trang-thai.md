...
| Sprint hiện hành | 🟡 **Sprint 2: Lõi thực thi trên `sim` (≈ A1)** — mã xong sớm, 2026-09-24 |
| Cột mốc tiếp theo | **M1: Time-to-first-value < 10 phút trên `sim`** |
| Trạng thái CI Lõi | ✅ **PASS 822/822 · SKIP 0** |
...
|  | **Sprint 3 — Action CI & Linux** *(≈ A2)* | **2026-10-26 → 2026-11-15** (Q-19) | **13 / 17** | 🟡 Action CI + HAL `linux` xong (2026-09-23); TSK-S3-14 chờ go-live; tiêu chí ra 5/6 |
