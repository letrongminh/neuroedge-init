...
| **Q-34** | ROS 2 / Nav2 | **ĐÃ CHỐT** *(2026-09-25, CPO)* | **Tích hợp nguyên bản** ROS 2 và Nav2 (không tự viết lại), qua adapter tại ranh giới gate; **gate xét mọi lệnh tốc độ**, kể cả khi Nav2 đang dẫn đường. Hệ quả: đây là **một tầng an toàn robot di động mới** (giới hạn tốc độ, vùng cấm, gate chạy 10–20 lần/giây, hướng ISO 13482) — cần RFC riêng, và câu trả lời C6 (chứng nhận an toàn) của cổng nhu cầu trước khi thiết kế. Thay đổi phạm vi đã loại ở `neuroedge-roadmap-phase2.md` (dẫn đường tự hành). |
